...
$pageTitle = 'Sales';
$pageScripts = ['pages/txn.js', 'pages/sales.js'];
  ...
  <div class="card-body">
    <div class="d-flex flex-wrap gap-2 justify-content-between mb-3">
      <div class="d-flex flex-wrap gap-2">
        <input id="searchInput" class="form-control" style="max-width:220px" placeholder="Invoice or customer...">
      ...
      <button id="addBtn" class="btn btn-primary"><i class="bi bi-plus-lg me-1"></i>New Sale</button>
    </div>
    <div class="table-responsive">
      <table class="table table-hover" id="dataTable">
        <thead><tr>
          <th>Invoice</th><th>Date</th><th>Customer</th><th>Sold by</th>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row g-3 mb-3">
          <div class="col-md-6">
            ...
            <select id="saleCustomer" class="form-select"><option value="">Walk-in customer</option></select>
          </div>
        </div>
        <div class="d-flex gap-2 mb-2">
          <select id="saleProduct" class="form-select"></select>
          <input id="saleQty" type="number" min="1" value="1" class="form-control" style="max-width:110px">
          <button id="addItemBtn" class="btn btn-outline-primary text-nowrap"><i class="bi bi-plus-lg"></i> Add</button>
        </div>
        <table class="table table-sm" id="itemsTable">
          <thead><tr><th>Product</th><th class="text-center">Qty</th><th class="text-end">Unit</th><th class="text-end">Subtotal</th><th></th></tr></thead>
          <tbody></tbody>
      ...
      <div class="modal-footer">
        ...
        <button id="saveSaleBtn" class="btn btn-primary">Complete Sale</button>
      </div>
    </div>
  </div>
</div>
