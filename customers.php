...
$pageTitle = 'Customers';
$pageScripts = ['crud.js', 'pages/customers.js'];
require __DIR__ . '/includes/header.php';
?>
<div class="card">
  <div class="card-body">
    <div class="d-flex flex-wrap gap-2 justify-content-between mb-3">
      <input id="searchInput" class="form-control" style="max-width:280px" placeholder="Search Customers...">
      <button id="addBtn" class="btn btn-primary"><i class="bi bi-plus-lg me-1"></i>Add Customer</button>
    </div>
